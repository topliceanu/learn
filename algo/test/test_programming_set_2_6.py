...
problem. Here are 6 different 2SAT instances: [./2sat1.txt] [./2sat2.txt]
[./2sat3.txt] [./2sat4.txt] [./2sat5.txt] [./2sat6.txt]
...
to ensure that it runs in a reasonable amount of time.) A third approach is via
backtracking. In lecture we mentioned this approach only in passing; see
