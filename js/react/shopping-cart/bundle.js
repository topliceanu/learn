...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactComponentTree = __webpack_require__(157);

	var _immutable = __webpack_require__(160);

	var Immutable = _interopRequireWildcard(_immutable);

	var _componentsCart = __webpack_require__(161);
	...
	//let app = React.render(<Cart items={items}/>, container);
	var app = _react2['default'].render(_react2['default'].createElement(_componentsCart2['default'], { items: immutableItems }), container);

	// Export/Import state.
	window._exportState = function () {
	    return (0, _reactComponentTree.serialize)(app);
	};
	window._importState = function (snapshot) {
	    app = (0, _reactComponentTree.render)({
	        component: _componentsCart2['default'],
	        snapshot: snapshot,
	        container: container
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function (t, e) {
	  true ? module.exports = e(__webpack_require__(158), __webpack_require__(1)) : "function" == typeof define && define.amd ? define(["lodash", "react"], e) : "object" == typeof exports ? exports.ComponentTree = e(require("lodash"), require("react")) : t.ComponentTree = e(t.lodash, t.react);
	  ...
	  return (function (t) {
	    ...
	    "use strict";t.exports = { Mixin: n(6), Component: n(5), loadChild: n(1), serialize: n(7).serialize, render: n(4).render, injectState: n(4).injectState };
	  }, function (t, e, n) {
	    "use strict";var r = n(2),
	        o = n(3);e.loadChild = function (t, e, n, c, u, a, s, l) {
	      var f = i.call(this, t, e, n, c, u, a, s, l);try {
	        return o.createElement(f.component, r.omit(f, "component", "children"), f.children);
	      } catch (s) {
	        console.error(s);
	      }
	    };var i = (function (_i) {
	      function i(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
	      ...
	      return i;
	    })(function (t, e, n, r, o, i, c, u) {
	      var a = t.children[e].call(t, n, r, o, i, c, u);return (a.ref || (a.ref = e), a);
	    });
	  }, function (e, n, r) {
	    e.exports = t;
	  }, function (t, n, r) {
	    ...
	    "use strict";var r = n(2),
	        o = n(3);e.render = function (t) {
	      var n = r.omit(t.snapshot, "state", "children"),
	          i = t.snapshot.state,
	          c = t.snapshot.children,
	          u = o.createElement(t.component, n, c),
	          a = o.render(u, t.container);return (r.isEmpty(i) || e.injectState(a, i), a);
	    }, e.injectState = function (t, n) {
	      var o = r.omit(n, "children"),
	          i = n.children;t.setState(o, function () {
	        r.isEmpty(i) || r.each(t.refs, function (t, n) {
	          r.isEmpty(i[n]) || e.injectState(t, i[n]);
	        });
	      });
	    };
	  }, function (t, e, n) {
	    "use strict";var r = function r(t, e) {
	      ...
	      function t(t, e) {
	        ...
	        i = function i(t, e) {
	      if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);t.prototype = Object.create(e && e.prototype, { constructor: { value: t, enumerable: !1, writable: !0, configurable: !0 } }), e && (t.__proto__ = e);
	    },
	        c = n(3),
	        u = n(1),
	        a = (function (t) {
	      ...
	      }return (i(e, t), o(e, [{ key: "loadChild", value: (function (t) {
	          function e(e, n, r, o, i, c, u) {
	            return t.apply(this, arguments);
	          }return (e.toString = function () {
	            return t.toString();
	          }, e);
	        })(function (t, e, n, r, o, i, c) {
	          return u.loadChild(this, t, e, n, r, o, i, c);
	        }) }]), e);
	    })(c.Component);t.exports = a;
	  }, function (t, e, n) {
	    "use strict";var r = n(1);t.exports = { loadChild: (function (t) {
	        function e(e, n, r, o, i, c, u) {
	          return t.apply(this, arguments);
	        }return (e.toString = function () {
	          return t.toString();
	        }, e);
	      })(function (t, e, n, o, i, c, u) {
	        return r.loadChild(this, t, e, n, o, i, c, u);
	      }) };
	  }, function (t, e, n) {
	    "use strict";var r = n(2);e.serialize = function (t) {
	      var e = r.clone(t.props),
	          n = o(t);return (r.isEmpty(n) || (e.state = n), e);
	    };var o = (function (t) {
	      function e(e) {
	        return t.apply(this, arguments);
	      }return (e.toString = function () {
	      ...
	      var e,
	          n = t.state ? r.clone(t.state) : {},
	          i = {};return (r.each(t.refs, function (t, n) {
	        e = o(t), r.isEmpty(e) || (i[n] = e);
	      }), r.isEmpty(i) || (n.children = i), n);
	    });
	  }]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartContentsJs = __webpack_require__(162);

	var _CartContentsJs2 = _interopRequireDefault(_CartContentsJs);

	var _CartTotalJs = __webpack_require__(167);

	var _CartTotalJs2 = _interopRequireDefault(_CartTotalJs);
	...
	var Cart = _react2['default'].createClass({
	    ...
	    findItemById: function findItemById(itemId) {
	        var found = this.state.items.filter(function (item) {
	    ...
	    incrementItem: function incrementItem(itemId) {
	    ...
	    decrementItem: function decrementItem(itemId) {
	        var item = this.findItemById(itemId);
	        if (item === undefined) {
	            return;
	        }
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_CartContentsJs2['default'], { ref: 'contents', items: this.state.items, inc: this.incrementItem, dec: this.decrementItem }),
	            _react2['default'].createElement(_CartTotalJs2['default'], { ref: 'total', items: this.state.items })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartItemJs = __webpack_require__(163);

	var _CartItemJs2 = _interopRequireDefault(_CartItemJs);

	var CartContents = _react2['default'].createClass({
	    displayName: 'CartContents',
	    ...
	    propTypes: {
	        ...
	        inc: _react2['default'].PropTypes.func.isRequired,
	        dec: _react2['default'].PropTypes.func.isRequired
	    },
	    getDefaultProps: function getDefaultProps() {
	        return {
	            items: []
	    ...
	    render: function render() {
	        ...
	        var cartItems = this.props.items.map(function (item, index) {
	            return _react2['default'].createElement(_CartItemJs2['default'], { ref: 'item' + index, item: item, key: index, inc: _this.props.inc, dec: _this.props.dec });
	        });
	        return _react2['default'].createElement(
	            'div',
	            null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartItemDescriptionJs = __webpack_require__(164);

	var _CartItemDescriptionJs2 = _interopRequireDefault(_CartItemDescriptionJs);

	var _CartItemCountJs = __webpack_require__(165);

	var _CartItemCountJs2 = _interopRequireDefault(_CartItemCountJs);

	var _CartItemTotalJs = __webpack_require__(166);

	var _CartItemTotalJs2 = _interopRequireDefault(_CartItemTotalJs);
	...
	var CartItem = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_CartItemDescriptionJs2['default'], { ref: 'itemDesc', desc: this.props.item.desc }),
	            _react2['default'].createElement(_CartItemCountJs2['default'], { ref: 'itemCount', count: this.props.item.count, itemId: this.props.item.id, inc: this.props.inc, dec: this.props.dec }),
	            _react2['default'].createElement(_CartItemTotalJs2['default'], { ref: 'itemTotal', value: this.props.item.value, count: this.props.item.count })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartItemDescription = _react2['default'].createClass({
	    displayName: 'CartItemDescription',
	...
	exports['default'] = CartItemDescription;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartItemCount = _react2['default'].createClass({
	    displayName: 'CartItemCount',

	    propTypes: {
	        itemId: _react2['default'].PropTypes.any.isRequired,
	        count: _react2['default'].PropTypes.number,
	        inc: _react2['default'].PropTypes.func.isRequired,
	        dec: _react2['default'].PropTypes.func.isRequired
	    },
	    ...
	    onIncClick: function onIncClick() {
	        this.props.inc(this.props.itemId);
	    },
	    onDecClick: function onDecClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartItemTotal = _react2['default'].createClass({
	    displayName: 'CartItemTotal',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartTotal = _react2['default'].createClass({
	    ...
	    computeTotal: function computeTotal() {
	        return this.props.items.reduce(function (collector, item) {
