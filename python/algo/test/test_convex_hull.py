...
from src.convex_hull import convex_hull_graham, convex_hull_jarvis


class TestConvexHull(unittest.TestCase):

    def test_convex_hull_simple(self):
        """ Given the following graph of points:
                                   |
                                   |
                                   *(0,9)
                                   |
        ...
        -+-+-+-+-*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*->
                     ...
                     *(-7,-7)      |               *(7,-7)
                                   ...
                                   *(0,-9)
                                   ...
                                   |
        """
        points = [(0, -9), (7, -7), (9, 0), (7, 7),
                  (0, 9), (-7, 7), (-9, 0), (-7, -7)]
        actual_hull = convex_hull_graham(points)
        self.assertItemsEqual(actual_hull, expected_hull,
                'should produce the correct convex hull')

    def test_convex_hull_complex(self):
        """ Given the test depicted here:
